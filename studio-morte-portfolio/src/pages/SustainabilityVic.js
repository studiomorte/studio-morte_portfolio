  ...
  return (
    <>
      <header className="project-pages_header">
        <img
          className="project-pages_logo logo-sustainabilityvic"
          src={brandLogo}
          alt="Sustainability Victoria Logo"
        />
        <div className="project-pages_hero-overlay"></div>
        <img
          className="project-pages_hero sustainabilityvic-hero"
          src={headerImg}
        ...
        <section className="project_summary">
          <div className="opening-block written left">
            ...
            <p>
              ...
              grow their own food and provide recipes and cooking ideas to make
              good use of their newly harvested crops.
            </p>
            <p>
              ...
              principles and trends must be leveraged to suit a modern audience.
            </p>
            <br />
          ...
          <div className="project-solution written right">
            ...
            <p>
              ...
              educating users on small-space gardening and supporting them with
              a genuinely useful app design. The app is loaded with an abundance
              of information, a helpful calendar & reminders feature, and the
              ability to use AR to ‘scan and save’ your garden.
            </p>
            <p>
        ...
        <section className="project-pages_case-study">
          ...
          <div className="written left">
            ...
            <p>
              ...
              living situation, how often they cook, and about their experience
              with growing their own food. I also conducted several surveys
              looking for more indepth answers to similar questions.
            </p>
            <p>
              With 40 responses to the online quiz I used sticky notes (and a
              lot of wall space) to create an affinity map to help visualise the
              data.
            </p>
          </div>
          ...
          <div className="project-pages_staggered-container">
            <div className="written left">
              ...
              <p>
                ...
                chamomile tea. Looking around the garden she see's the potential
                for a lovely vegetable patch, possibly some fruit tree's along
                the fence, and maybe some potted herbs. She starts browsing
                Pinterest on her mobile phone for inspiration.
              </p>
              <p>
                After some time she realises that although she's looking through
                some truly gorgeous gardens, she hasn't actually learned
                anything. “How can I make my own garden look this good and be
                practical?” She wonders, wishing that there was an easier way to
            ...
            <div className="written right">
              ...
              <p>
                ...
                opportunity to teach himself how to cook some simple dinners for
                himself and his younger sister. He spends the afternoon browsing
                recipes instead of studying and becomes overwhelmed by the sheer
                volume of recipes to choose from.
              </p>
              <p>
                Eventually he decides to try and cook a chicken and bacon pasta
                dish using a recipe he found on Google. Having never cooked
                chicken on his own before he's nervous about undercooking it -
                he overcooks the chicken but lucking this is masked by the
                excessive sauce used in the pasta bake.
              </p>
            </div>
            <div className="written left">
              <h2>Scenario: Rosie Cheng</h2>
              <p>
                Rosie gets home from work earlier than usual and decides to cook
                an easy dinner for her and her partner. She opens the fridge to
                see what she could possibly cook only to discover that they
                forgot to do their usual grocery shop on the weekend. Thankfull
                they have many of the usual ingredients, however all of their
                vegetables are off.
              </p>
              <p>
                Frustrated, she looks at the time and decides to quickly rush to
                the local grocery store to buy some tomatoes and spinach.
              </p>
            </div>
          </div>
          ...
          <div className="written left">
            <p>
              Informed by the user research, the brief required three variations
              of the potential app design. Based on current design trends I
              opted to include augmented reality in the app design following the
              ideation process. In the final chosen concept I created a design
              catered to visually impaired users. This required consideration
              for high-contrast, large fonts, and large buttons. There was also
              the added challenge of adapting my augmented reality concept for
              these users.{" "}
            </p>
          ...
          <div className="written left">
            <p>
              After finalising the entire app design I created two variations of
            ...
            <p>
              ...
              preferred the written list for the recipes section. A toggle
              between images and written lists would be ideal for the final
              design to give users the freedom of choice. The dashboard was
              determined to be underutilised and the suggestion was made to
              remove the navigation menu and include the links on the dashboard.
              Users also failed to use the bottom tab navigation, instead using
              the hamburger menu.
            </p>
          </div>
