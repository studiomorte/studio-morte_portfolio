...
/* IMAGES */
import headerImg from "./../images/project-djaliny/djaliny2.jpg";
import featureImg from "./../images/project-djaliny/djaliny1.jpg";
import brandLogo from "./../images/project-djaliny/logo-djaliny.png";
import curtinLogo from "./../images/project-djaliny/logo-curtin.png";
import adobeLogo from "./../images/project-djaliny/logo-adobe.png";
import linkedinLogo from "./../images/project-djaliny/logo-linkedin.png";
import unityLogo from "./../images/project-djaliny/logo-unity.png";
import persona1 from "./../images/project-djaliny/persona-djaliny1.jpg";
import persona2 from "./../images/project-djaliny/persona-djaliny2.jpg";
      ...
      <div className="djaliny">
        ...
        <section className="project__container">
          <section className="project__summary">
            <h1 className="project__title-banner">
            ...
            <div className="written left">
              <h2>Overview</h2>
              <p>
                The Curtin Creative Jam is an intensive design competition open
                to all current Curtin students. The CCJ21 theme focused on the
            ...
            <div className="project__sponsors">
              <h3>Sponsored By</h3>
              <div>
            ...
            <div className="project__problem full-width">
              <p>
                ...
                Islander peoples and those of other cultural backgrounds, based
            ...
            <div className="project__solution written right">
              <h3>The Solution</h3>
              <p>
                Djaliny (Noongar for “listening”) is a mobile app that delivers
                a relaxing auditory experience through nature sounds, music, and
              ...
              <p>
                ...
                themselves in The Dreamtime and the natural sounds of the past
                we can help people feel more relaxed, more knowledgable, and
                more connected to country.
              </p>
            </div>
          ...
          <section className="project__case-study">
            ...
            <div className="written left">
              <p>
                As team leader I oversaw each step of the design process,
                created an action plan, and delegated tasks based on the
                strength of each team member. With the three of us juggling work
                commitments project planning was critical to the success of the
                design.
              </p>
              <p>
              ...
              <p>
                ...
                assisted with ideation, and helped to fine-tune the app design
                by focusing on the small details. I created the final
                presentation document with assistance from my two team members,
                who both ensured that the app prototype had the appropriate
                audio included.
              </p>
            </div>
            ...
            <div className="written left">
              <h3>Ideation</h3>
              <p>
                Following the day one opening activities on campus the three of
                us spent the evening brainstorming potential design ideas. The
                next day I collated these ideas and pitched them to a small
                group of design leaders and a cultural advisor. The opportunity
                to bounce ideas around the group was incredible and truly helped
                in narrowing the ideas down to one solid concept. With
                confirmation from all group members we began brainstorming
                specific app features and sketching low-fidelity wireframes.
              </p>
            </div>
            ...
            <div className="written left">
              ...
              <p>
                ...
                focused on understanding the potential target audience,
                searching for information about Aboriginal languages and
                Dreamtime stories, and exploring the feasibility of tying native
                nature sounds to specific locations.
              </p>
              <p>
                ...
                the future and social change, are likely to use social media,
                want to make a positive impact on society, and are able to teach
                their parents and their children.
              </p>
            </div>

            <div className="project__persona-container right">
              <div className="project__persona quote ">
                <img
                  src={persona1}
                  alt="Girl with brown hair looking at the camera"
                />
                <p>
                  Jessica has an appreciation for Australian landscape and
                  nature, but knows a limited amount about indigenous history
                  and culture from what she learnt in school
                </p>
              </div>
              <div className="project__persona quote">
                <img
            ...
            <div className="written left">
              ...
              <p>
                ...
                into the night I intermittently jumped into the file to make
                minor aesthetic adjustments on the fly. Meanwhile Mali spent the
                evening creating a voice recording of a Dreamtime story that
                would be included in the final prototype video.
              </p>
            </div>
            ...
            <div className="written left">
              ...
              <p>
                With little sleep and the presentations start time looming
                myself and Mali arrived on campus early to put together the
                final presentation and make final adjustments to the prototype,
            ...
            <div className="written left">
              <p>
                Despite everyone in the room running on limited sleep, seeing
                the design solutions that other groups had created was an
                intriguing experience. We had some technical difficulties
                getting the audio working for our presentation, but we
                ultimately pitched our design in a concise manner which was a
                welcome change following several lengthy presentations.
              </p>
              <p>
              ...
              <p>
                Participating in the Curtin Creative Jam was a once in a
                lifetime experience and being recognised with the first place
                award was a truly incredible feeling.
              </p>
            </div>
